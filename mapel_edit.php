...
<div class="row">
    <div class="col-lg-5">
        ...
        <?php
            $kode = @$_GET['id'];
            $qrykoreksi=mysqli_query($conn, "select * from tb_mapel where id_mapel='$kode'") or die (mysqli_error());
        ...
        <?php
            if(@$_POST['edit']){
                ...
                $query=mysqli_query($conn, "update tb_mapel set kode_mapel='$kode_mapel', mapel='$mapel' where id_mapel='$kode'") or die (mysqli_error());

...
<form method="post">
    ...
    if(@$_POST['input']){
        ...
        $query1=mysqli_query($conn, "insert into tb_pengguna(username, pass, status) values('$username','$pass', '$status')") or die (mysqli_error());

        $query=mysqli_query($conn, "insert into tb_guru(nip, nama_guru, kode_guru, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, agama) 

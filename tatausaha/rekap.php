                ...
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-right:20px; border-right: 1px solid #ccc;">
                        <table class="table table-hover table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                    $view1=mysqli_query($conn, "select nis, nama_siswa
                                                        from tb_siswa
                                ...
                                <tr>
                                    ...
                                    <td><?php echo mysqli_num_rows(mysqli_query($conn, "select * from tb_absensih where nis='$raw1[nis]' AND ket='H' AND tanggal between '$tanggal1' and '$tanggal2'")); ?></td>  
                                    <td><?php echo mysqli_num_rows(mysqli_query($conn, "select * from tb_absensih where nis='$raw1[nis]' AND ket='S' AND tanggal between '$tanggal1' and '$tanggal2'")); ?></td>
                                    <td><?php echo mysqli_num_rows(mysqli_query($conn, "select * from tb_absensih where nis='$raw1[nis]' AND ket='I' AND tanggal between '$tanggal1' and '$tanggal2'")); ?></td>
                                    <td><?php echo mysqli_num_rows(mysqli_query($conn, "select * from tb_absensih where nis='$raw1[nis]' AND ket='A' AND tanggal between '$tanggal1' and '$tanggal2'")); ?></td>   
                                </tr>
                                <?php
                                    $no++;
                                    }

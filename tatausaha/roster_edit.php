...
<div class="row">
    ...
    <?php
        $id = @$_GET['id'];
        $qrykoreksi=mysqli_query($conn, "select * from tb_jadwal where id_jadwal='$id'");
    ...
    <form method="post">
        <div class="col-lg-7">
            ...
            <div class="form-group">
                ...
                <select name="id_mengajar" class="form-control" >
                    <option value="" selected="selected">Guru -- Mapel</option>
                    <?php 
                        $query=mysqli_query($conn, "select tb_guru.nama_guru, tb_mengajar.id_mengajar, tb_mapel.mapel from tb_guru, tb_mengajar, tb_mapel 
        ...
        <div class="col-lg-5">
            ...
            <div class="form-group">
                ...
                <input type="time" class="form-control" name="jam_berakhir" value="<?php echo $data['jam_berakhir']; ?>" >
            </div>
        </div>
</div>
    ...
    <?php
        if(@$_POST['edit']){
            ...
            $query=mysqli_query($conn, "UPDATE tb_jadwal SET id_mengajar='$id_mengajar', hari='$hari', jam_mulai='$jam_mulai',
                            jam_berakhir='$jam_berakhir', id_kelas='$kelas' WHERE id_jadwal='$id'") or die (mysqli_error());

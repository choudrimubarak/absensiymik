<?php
	...
	$sQuery = "
		...
		$sLimit
	";
	$rResult = mysqli_query($conn,  $sQuery, $gaSql['link'] ) or die(mysqli_error());
	
	/* Data set length after filtering */
	$sQuery = "
		SELECT FOUND_ROWS()
	";
	$rResultFilterTotal = mysqli_query($conn,  $sQuery, $gaSql['link'] ) or die(mysqli_error());
	...
	$sQuery = "
		...
		FROM   $sTable
	";
	$rResultTotal = mysqli_query($conn,  $sQuery, $gaSql['link'] ) or die(mysqli_error());

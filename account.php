...
<div class="row">
    <div class="col-lg-5">
        ...
        if(@$_POST['input']){
            ...
            $query=mysqli_query($conn, "insert into tb_pengguna(username, pass, status) values('$username','$pass','$status')") or die (mysqli_error());
    ...
    <div class="col-lg-7">
        ...
        <div class="table-responsive">
            <?php
                $view=mysqli_query($conn, "select * from tb_pengguna order by username desc");
                $no=0;
            ?>
